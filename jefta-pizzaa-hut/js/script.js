...
$('.nav-link').on('click', function(){
    $('.nav-link').removeClass('active'); // Menghapus kelas 'active' dari semua elemen dengan kelas '.nav-link'
    $(this).addClass('active'); // Menambahkan kelas 'active' hanya pada elemen yang diklik
